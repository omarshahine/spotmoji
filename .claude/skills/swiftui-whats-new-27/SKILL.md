...
description: >-
  ...
  - Presenting a confirmationDialog or alert from an optional item binding
---

<!-- local: apple-xcode-skills -->
> **Precedence (added by apple-xcode-skills, not part of Apple's text).** This skill overlaps
> the per-project skills swiftui-expert-skill, swiftui-ui-patterns, swiftui-liquid-glass. Those stay installed. Where they disagree with this
